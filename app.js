...
document.getElementById('liturismo').addEventListener('click', function () {
  let cidadeId = 2;
  window.location.href = `turismo.html?id=${cidadeId}`;
});
...
document.getElementById('lirestaurantes').addEventListener('click', function () {
  let cidadeId = 2;
  window.location.href = `restaurantes.html?id=${cidadeId}`;
});
...
document.getElementById('lieventos').addEventListener('click', function () {
  let cidadeId = 2;
  window.location.href = `eventos.html?id=${cidadeId}`;
});

// Para o botão dentro do conteúdo
// Botão “Voltar para Home”
document.addEventListener('DOMContentLoaded', function () {
  // Listener para o botão ou imagem de "Voltar para o Home"
  document.getElementById('backhome').addEventListener('click', function () {
    // Vai redirecionar para a página inicial
